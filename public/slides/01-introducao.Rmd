...
**Site:** http://www.est.ufmg.br/~thaispaiva/Disciplinas/2020_2/MetComp/

  - informações gerais;
  - cronograma atualizado;
  - materiais de aula (slides, arquivos de código, etc.).
  
**Moodle:** Turma TOPICOS ESPECIAIS EM ATUARIA - TTA
...
- Para a próxima aula:
    ...
    2) Instalar (ou atualizar) a versão mais recente do `R` e `RStudio` (links na seção [*Ferramentas*](http://www.est.ufmg.br/~thaispaiva/Disciplinas/2020_2/MetComp/ferramentas/) do site).
