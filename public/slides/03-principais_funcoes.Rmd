...
- Para criar matriz com as variáveis *dummy*:
```{r}
model.matrix(~0+x)
...
## Expressões Simbólicas - Exemplo {.smaller}
...
- Vamos ajustar o modelo mais básico:
...
- Como o R é m *open-source*, podemos ver o código de todas as funções.
