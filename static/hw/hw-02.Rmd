...
date: "Entrega: **09/01/2021** via Moodle (até as 23:59)"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
Você irá entregar essa lista de exercício no Moodle da disciplina. Você deverá submeter o **arquivo gerado automaticamente pelo R** usando *markdown*, preferencialmente o pdf. Para isso, siga as instruções abaixo para instalar os demais programas e pacotes. 
...
<!-- Sugestão de respostas: [Resolução Lista 2](./resolucao/lista-02-resolucao.html) -->
