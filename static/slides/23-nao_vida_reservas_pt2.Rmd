...
- O modelo *Mack* assume que os fatores para cada período de desenvolvimento são constantes para todos os períodos de origem (condição 1), qye a volatilidade decresce à medida que os pagamentos são feitos (condição 2), e todos os períodos de origem são independentes e não há mudança estrutural ou sazonalidade (condição 3).
...
```{r echo=FALSE, fig.align='center', out.height="100%", message=FALSE, warning=FALSE}
## gráfico de resíduos
