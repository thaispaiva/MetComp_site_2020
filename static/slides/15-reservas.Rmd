...
- A <span class="black">**reserva**</span> de uma apólice consiste no valor que a seguradora precisa ter em um determinado momento para, juntamente com os prêmios futuros que venha a receber, consiga honrar com seus pagamentos futuros de indenizações.
...
- <span class="black">**Prospectivo:**</span> a reserva é calculada como a diferença entre os valores presentes atuariais dos benefícios futuros e dos prêmios futuros.

$${}_{t}V = VPA(\mbox{benefícios futuros}) - VPA(\mbox{prêmios futuros}) $$

- <span class="black">**Retrospectivo:**</span> a reserva é calculada como a diferença entre os valores acumulados dos benefícios pagos e os prêmios recebidos.
