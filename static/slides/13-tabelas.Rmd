...
- Fluxos de pagamentos determinísticos
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/e0x.png")
```

- Esperança de vida completa entre as idades $x$ e $x+n$:

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/e0xn.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/e0_80_10.png")
```
